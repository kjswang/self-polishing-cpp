...
void M16iBproperty(){
    ...
    // delta_t = 0.5;
    // thetamax.resize(6,2);
    // thetamax = arma::reshape( arma::vec{-pi, pi,
    //             0, pi,
    //             -pi, pi,
    //             -pi, pi,
    //             -pi/2, pi/2,
    ...
    // thetadotmax.resize(6,1);
    // thetadotmax = arma::reshape(arma::vec{1,
    //                1,
    //                1,
    //                1,
    //                0.5,
    ...
    // DH.resize(6,4);
    // DH = arma::reshape(arma::vec{0.5, 0.65, 0.15, 1.5708,
    //       1.5708, 0, 0.77, 0,
    //       0, 0, 0.1, 1.5708,
    //       0, 0.74, 0, -1.5708,
    //       -pi/2, 0, 0, 1.5708,
    ...
    // // 0
    // cap[0].p.resize(3,2);
    // cap[0].p = arma::reshape(arma::vec{0, 0,
    //             0, 0,
    //             -0.1, 0.1},3,2);      
    // cap[0].r = 0.15;
    // // 1
    // cap[1].p.resize(3,2);
    // cap[1].p << arma::reshape(arma::vec{-0.75, 0,
    //             0, 0,
    //             -0.15, -0.15},3,2); 
    // cap[1].r = 0.13;
    // // 2
    // cap[2].p.resize(3,2);
    // cap[2].p = arma::reshape(arma::vec{-0.03, -0.03,
    //             0, 0,
    //             0.05, 0.05},3,2);   
    // cap[2].r = 0.22;
    // // 3
    // cap[3].p.resize(3,2);
    // cap[3].p = arma::reshape(arma::vec{0, 0,
    //             0, 0.55,
    //             0, 0},3,2);
    // cap[3].r = 0.11;
    // // 4
    // cap[4].p.resize(3,2);
    // cap[4].p = arma::reshape(arma::vec{0, 0,
    //             0, 0,
    //             -0.05, 0.110},3,2);
    // cap[4].r = 0.07;
    // // 5
    // cap[5].p.resize(3,2);
    // cap[5].p = arma::reshape(arma::vec{-0.11, -0.11,
    //             0, 0,
    //             0.09, 0.09},3,2);
    // cap[5].r = 0.07;
